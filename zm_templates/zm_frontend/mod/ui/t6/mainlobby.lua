...
LUI.createMenu.MainLobby = function (LocalClientIndex)
	...
	MainLobbyWidget:registerEventHandler("play_zm_frontend", CoD.MainLobby.PlayFrontend)
...
CoD.MainLobby.PlayFrontend = function(MainLobbyWidget, ClientInstance)
	Engine.Exec(ClientInstance.controller, "exec zm_frontend")
end
