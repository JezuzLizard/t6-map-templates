...
{
    self.accuracy = 1;
    self.animstatedef = "zm_karma_basic.asd";
    self.animtree = "zm_karma_basic.atr";
    self.csvinclude = "";
...
precache( ai_index )
{
    ...
    precacheanimstatedef( ai_index, #animtree, "zm_karma_basic" );
