...
dog_round_aftermath()
{
    ...
    if ( isdefined( power_up_origin ) )
    {
        ...
        if ( level.dog_drop_perk && any_door_has_been_bought() )
        {
            level thread maps\mp\zombies\_zm_powerups::specific_powerup_drop( "free_perk", power_up_origin + ( 32, 0, 0 ) );
        }
    }
