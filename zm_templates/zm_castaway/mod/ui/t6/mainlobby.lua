...
CoD.MainLobby.PopulateButtons_Zombie = function (MainLobbyButtonPane)
	MainLobbyButtonPane.body.playCoveButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("PLAY COVE"), nil, 1)
	MainLobbyButtonPane.body.playCoveButton.hintText = "An island of the undead..."
	MainLobbyButtonPane.body.playCoveButton:setActionEventName("play_zm_castaway")
...
LUI.createMenu.MainLobby = function (LocalClientIndex)
	...
	MainLobbyWidget:registerEventHandler("play_zm_castaway", CoD.MainLobby.PlayCove)
