...
#using_animtree("zm_castaway_basic");
...
{
    self.accuracy = 1;
    self.animstatedef = "zm_castaway_basic.asd";
    self.animtree = "zm_castaway_basic.atr";
    self.csvinclude = "";
...
precache( ai_index )
{
    ...
    precacheanimstatedef( ai_index, #animtree, "zm_castaway_basic" );
